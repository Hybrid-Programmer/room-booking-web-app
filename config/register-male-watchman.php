        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL)){
            ...
            if(mysqli_num_rows($sql) > 0){
                ...
                if(isset($_FILES['profile']['name'])){
                    $targetDir = "../uploads";//The folder on the server that stores all the uploaded images
                    ...
                    if(in_array($img_ext, $extensions) === true){
                            ...
                            //Capitalize the first letters of the names
                             ...
                             $date = date('M d, Y');
                            if(move_uploaded_file($tmp_name, "$targetDir/".$newName)){ //Move the uploaded image to this folder on the server
