...
$sql = "SELECT roomID FROM male_rooms WHERE status = 'booked'";
...
$sql = "SELECT profile, email, contact FROM male_users WHERE booked_roomID = '$room_ID'";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT * FROM male_rooms WHERE status = 'booked'";
$result = mysqli_query($conn, $sql);
